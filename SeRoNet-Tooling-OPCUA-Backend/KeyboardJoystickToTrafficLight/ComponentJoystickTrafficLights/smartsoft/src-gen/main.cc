...
int main(int argc, char *argv[])
{
	...
	ComponentJoystickTrafficLights::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentJoystickTrafficLights::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentJoystickTrafficLights::instance()->fini();
	// destroy the component's singleton
	ComponentJoystickTrafficLights::deleteInstance();
