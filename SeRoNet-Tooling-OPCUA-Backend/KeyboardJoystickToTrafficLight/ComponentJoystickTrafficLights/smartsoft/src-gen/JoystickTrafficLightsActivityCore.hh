...
//--------------------------------------------------------------------------
#ifndef _JOYSTICKTRAFFICLIGHTSACTIVITY_CORE_HH
#define _JOYSTICKTRAFFICLIGHTSACTIVITY_CORE_HH
...
#include <JoystickTrafficLightsActivityObserverInterface.hh>
	
class JoystickTrafficLightsActivityCore
...
private:
	...
	std::list<JoystickTrafficLightsActivityObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(JoystickTrafficLightsActivityObserverInterface *observer);
	void detach_interaction_observer(JoystickTrafficLightsActivityObserverInterface *observer);

public:
	JoystickTrafficLightsActivityCore(Smart::IComponent *comp, const bool &useDefaultState=true)
	...
	{  }
	virtual ~JoystickTrafficLightsActivityCore()
	{  }
