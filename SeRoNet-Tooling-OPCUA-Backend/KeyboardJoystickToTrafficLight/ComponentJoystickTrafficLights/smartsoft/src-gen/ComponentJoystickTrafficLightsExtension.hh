...
#ifndef COMPONENTJOYSTICKTRAFFICLIGHTS_EXTENSION_HH_
#define COMPONENTJOYSTICKTRAFFICLIGHTS_EXTENSION_HH_
...
public:
	ComponentJoystickTrafficLightsExtension(const std::string &name);
	virtual ~ComponentJoystickTrafficLightsExtension();
...
#endif /* COMPONENTJOYSTICKTRAFFICLIGHTS_EXTENSION_HH_ */
