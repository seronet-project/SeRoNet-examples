#!/bin/bash
#
# This script is run prior to deployment of component ComponentKeyboardJoystick
...
#source $REFERENCED_PROJECT_ComponentKeyboardJoystick/smartsoft/src/predeploy.sh
