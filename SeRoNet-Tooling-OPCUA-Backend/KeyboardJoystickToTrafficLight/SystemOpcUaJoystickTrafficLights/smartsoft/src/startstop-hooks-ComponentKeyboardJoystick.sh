#!/bin/bash
#
# Start-Stop-Hooks for component ComponentKeyboardJoystick
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentKeyboardJoystick.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentKeyboardJoystick.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentKeyboardJoystick.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentKeyboardJoystick.sh post-stop
