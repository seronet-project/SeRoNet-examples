#!/bin/bash
#
# Start-Stop-Hooks for component ComponentJoystickTrafficLights
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentJoystickTrafficLights.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentJoystickTrafficLights.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentJoystickTrafficLights.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentJoystickTrafficLights.sh post-stop
