#!/bin/bash
#
# This script is run prior to deployment of component ComponentJoystickTrafficLights
...
#source $REFERENCED_PROJECT_ComponentJoystickTrafficLights/smartsoft/src/predeploy.sh
