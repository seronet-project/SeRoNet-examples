...
//--------------------------------------------------------------------------
#ifndef COMMBASICOBJECTS_LASERSCANPOINT_ACE_H_
#define COMMBASICOBJECTS_LASERSCANPOINT_ACE_H_

#include "CommBasicObjects/LaserScanPoint.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure LaserScanPoint
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const CommBasicObjectsIDL::LaserScanPoint &data);

// de-serialization operator for DataStructure LaserScanPoint
...
#endif /* COMMBASICOBJECTS_LASERSCANPOINT_ACE_H_ */
