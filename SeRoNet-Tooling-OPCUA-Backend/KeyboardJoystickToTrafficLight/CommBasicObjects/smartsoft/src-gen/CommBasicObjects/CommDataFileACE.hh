...
//--------------------------------------------------------------------------
#ifndef COMMBASICOBJECTS_COMMDATAFILE_ACE_H_
#define COMMBASICOBJECTS_COMMDATAFILE_ACE_H_

#include "CommBasicObjects/CommDataFile.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure CommDataFile
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const CommBasicObjectsIDL::CommDataFile &data);

// de-serialization operator for DataStructure CommDataFile
...
#endif /* COMMBASICOBJECTS_COMMDATAFILE_ACE_H_ */
