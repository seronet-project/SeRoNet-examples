...
//--------------------------------------------------------------------------
#ifndef _KEYBOARDACTIVITY_CORE_HH
#define _KEYBOARDACTIVITY_CORE_HH
...
#include <KeyboardActivityObserverInterface.hh>


class KeyboardActivityCore
...
private:
	...
	std::list<KeyboardActivityObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(KeyboardActivityObserverInterface *observer);
	void detach_interaction_observer(KeyboardActivityObserverInterface *observer);

public:
	KeyboardActivityCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~KeyboardActivityCore();
