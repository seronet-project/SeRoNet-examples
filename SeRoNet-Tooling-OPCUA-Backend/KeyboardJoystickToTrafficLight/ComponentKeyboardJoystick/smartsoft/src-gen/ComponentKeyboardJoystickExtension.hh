...
#ifndef COMPONENTKEYBOARDJOYSTICK_EXTENSION_HH_
#define COMPONENTKEYBOARDJOYSTICK_EXTENSION_HH_
...
public:
	ComponentKeyboardJoystickExtension(const std::string &name);
	virtual ~ComponentKeyboardJoystickExtension();
...
#endif /* COMPONENTKEYBOARDJOYSTICK_EXTENSION_HH_ */
