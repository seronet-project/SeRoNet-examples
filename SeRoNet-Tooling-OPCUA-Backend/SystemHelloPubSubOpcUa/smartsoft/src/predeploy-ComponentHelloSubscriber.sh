#!/bin/bash
#
# This script is run prior to deployment of component ComponentHelloSubscriber
...
source $REFERENCED_PROJECT_ComponentHelloSubscriber/smartsoft/src/predeploy.sh
