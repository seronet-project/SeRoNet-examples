#!/bin/bash
#
# Start-Stop-Hooks for component ComponentHelloSubscriber
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentHelloSubscriber.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentHelloSubscriber.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentHelloSubscriber.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentHelloSubscriber.sh post-stop
