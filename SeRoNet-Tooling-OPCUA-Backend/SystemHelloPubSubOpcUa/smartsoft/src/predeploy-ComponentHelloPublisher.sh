#!/bin/bash
#
# This script is run prior to deployment of component ComponentHelloPublisher
...
source $REFERENCED_PROJECT_ComponentHelloPublisher/smartsoft/src/predeploy.sh
