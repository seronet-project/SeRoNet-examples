...
#ifndef COMPONENTHELLOSUBSCRIBER_OPC_UA_BACKEND_PORTFACTORY_HH_
#define COMPONENTHELLOSUBSCRIBER_OPC_UA_BACKEND_PORTFACTORY_HH_
...
class ComponentHelloSubscriberOpcUaBackendPortFactory: public ComponentHelloSubscriberPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	ComponentHelloSubscriberOpcUaBackendPortFactory();
	virtual ~ComponentHelloSubscriberOpcUaBackendPortFactory();
...
#endif /* COMPONENTHELLOSUBSCRIBER_SERONET_SDK_PORTFACTORY_HH_ */
