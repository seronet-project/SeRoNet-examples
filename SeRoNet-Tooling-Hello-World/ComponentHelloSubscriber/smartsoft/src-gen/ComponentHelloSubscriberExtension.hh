...
#ifndef COMPONENTHELLOSUBSCRIBER_EXTENSION_HH_
#define COMPONENTHELLOSUBSCRIBER_EXTENSION_HH_
...
public:
	ComponentHelloSubscriberExtension(const std::string &name);
	virtual ~ComponentHelloSubscriberExtension();
...
#endif /* COMPONENTHELLOSUBSCRIBER_EXTENSION_HH_ */
