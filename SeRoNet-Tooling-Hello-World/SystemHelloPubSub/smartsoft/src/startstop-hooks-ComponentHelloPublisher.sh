#!/bin/bash
#
# Start-Stop-Hooks for component ComponentHelloPublisher
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentHelloPublisher.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentHelloPublisher.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentHelloPublisher.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentHelloPublisher.sh post-stop
