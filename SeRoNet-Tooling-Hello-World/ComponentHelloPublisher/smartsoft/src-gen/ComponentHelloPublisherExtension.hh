...
#ifndef COMPONENTHELLOPUBLISHER_EXTENSION_HH_
#define COMPONENTHELLOPUBLISHER_EXTENSION_HH_
...
public:
	ComponentHelloPublisherExtension(const std::string &name);
	virtual ~ComponentHelloPublisherExtension();
...
#endif /* COMPONENTHELLOPUBLISHER_EXTENSION_HH_ */
