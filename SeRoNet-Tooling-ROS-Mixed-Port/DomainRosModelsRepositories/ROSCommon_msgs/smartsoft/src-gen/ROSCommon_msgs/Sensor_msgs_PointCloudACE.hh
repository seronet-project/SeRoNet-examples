...
//--------------------------------------------------------------------------
#ifndef ROSCOMMON_MSGS_SENSOR_MSGS_POINTCLOUD_ACE_H_
#define ROSCOMMON_MSGS_SENSOR_MSGS_POINTCLOUD_ACE_H_

#include "ROSCommon_msgs/Sensor_msgs_PointCloud.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Sensor_msgs_PointCloud
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Sensor_msgs_PointCloud &data);

// de-serialization operator for DataStructure Sensor_msgs_PointCloud
...
#endif /* ROSCOMMON_MSGS_SENSOR_MSGS_POINTCLOUD_ACE_H_ */
