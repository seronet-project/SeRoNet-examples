...
//--------------------------------------------------------------------------
#ifndef ROSCOMMON_MSGS_SENSOR_MSGS_LASERSCAN_ACE_H_
#define ROSCOMMON_MSGS_SENSOR_MSGS_LASERSCAN_ACE_H_

#include "ROSCommon_msgs/Sensor_msgs_LaserScan.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Sensor_msgs_LaserScan
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Sensor_msgs_LaserScan &data);

// de-serialization operator for DataStructure Sensor_msgs_LaserScan
...
#endif /* ROSCOMMON_MSGS_SENSOR_MSGS_LASERSCAN_ACE_H_ */
