...
//--------------------------------------------------------------------------
#ifndef ROSCOMMON_MSGS_NAV_MSGS_GETMAPACTION_ACE_H_
#define ROSCOMMON_MSGS_NAV_MSGS_GETMAPACTION_ACE_H_

#include "ROSCommon_msgs/Nav_msgs_GetMapAction.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Nav_msgs_GetMapAction
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Nav_msgs_GetMapAction &data);

// de-serialization operator for DataStructure Nav_msgs_GetMapAction
...
#endif /* ROSCOMMON_MSGS_NAV_MSGS_GETMAPACTION_ACE_H_ */
