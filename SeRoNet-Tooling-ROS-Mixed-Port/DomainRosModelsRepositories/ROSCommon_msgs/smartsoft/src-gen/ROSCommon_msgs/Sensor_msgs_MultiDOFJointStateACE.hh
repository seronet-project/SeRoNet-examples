...
//--------------------------------------------------------------------------
#ifndef ROSCOMMON_MSGS_SENSOR_MSGS_MULTIDOFJOINTSTATE_ACE_H_
#define ROSCOMMON_MSGS_SENSOR_MSGS_MULTIDOFJOINTSTATE_ACE_H_

#include "ROSCommon_msgs/Sensor_msgs_MultiDOFJointState.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Sensor_msgs_MultiDOFJointState
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Sensor_msgs_MultiDOFJointState &data);

// de-serialization operator for DataStructure Sensor_msgs_MultiDOFJointState
...
#endif /* ROSCOMMON_MSGS_SENSOR_MSGS_MULTIDOFJOINTSTATE_ACE_H_ */
