...
//--------------------------------------------------------------------------
#ifndef ROSCOMMON_MSGS_SENSOR_MSGS_RELATIVEHUMIDITY_ACE_H_
#define ROSCOMMON_MSGS_SENSOR_MSGS_RELATIVEHUMIDITY_ACE_H_

#include "ROSCommon_msgs/Sensor_msgs_RelativeHumidity.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Sensor_msgs_RelativeHumidity
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Sensor_msgs_RelativeHumidity &data);

// de-serialization operator for DataStructure Sensor_msgs_RelativeHumidity
...
#endif /* ROSCOMMON_MSGS_SENSOR_MSGS_RELATIVEHUMIDITY_ACE_H_ */
