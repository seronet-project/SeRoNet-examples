...
//--------------------------------------------------------------------------
#ifndef ROSCOMMON_MSGS_SENSOR_MSGS_NAVSATFIX_ACE_H_
#define ROSCOMMON_MSGS_SENSOR_MSGS_NAVSATFIX_ACE_H_

#include "ROSCommon_msgs/Sensor_msgs_NavSatFix.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Sensor_msgs_NavSatFix
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Sensor_msgs_NavSatFix &data);

// de-serialization operator for DataStructure Sensor_msgs_NavSatFix
...
#endif /* ROSCOMMON_MSGS_SENSOR_MSGS_NAVSATFIX_ACE_H_ */
