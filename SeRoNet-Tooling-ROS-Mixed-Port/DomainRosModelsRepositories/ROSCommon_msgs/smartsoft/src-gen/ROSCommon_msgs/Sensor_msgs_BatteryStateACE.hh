...
//--------------------------------------------------------------------------
#ifndef ROSCOMMON_MSGS_SENSOR_MSGS_BATTERYSTATE_ACE_H_
#define ROSCOMMON_MSGS_SENSOR_MSGS_BATTERYSTATE_ACE_H_

#include "ROSCommon_msgs/Sensor_msgs_BatteryState.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Sensor_msgs_BatteryState
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Sensor_msgs_BatteryState &data);

// de-serialization operator for DataStructure Sensor_msgs_BatteryState
...
#endif /* ROSCOMMON_MSGS_SENSOR_MSGS_BATTERYSTATE_ACE_H_ */
