...
//--------------------------------------------------------------------------
#ifndef ROSCOMMON_MSGS_DIAGNOSTIC_MSGS_ADDDIAGNOSTICSRESPONSE_ACE_H_
#define ROSCOMMON_MSGS_DIAGNOSTIC_MSGS_ADDDIAGNOSTICSRESPONSE_ACE_H_

#include "ROSCommon_msgs/Diagnostic_msgs_AddDiagnosticsResponse.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Diagnostic_msgs_AddDiagnosticsResponse
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Diagnostic_msgs_AddDiagnosticsResponse &data);

// de-serialization operator for DataStructure Diagnostic_msgs_AddDiagnosticsResponse
...
#endif /* ROSCOMMON_MSGS_DIAGNOSTIC_MSGS_ADDDIAGNOSTICSRESPONSE_ACE_H_ */
