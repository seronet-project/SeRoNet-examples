...
//--------------------------------------------------------------------------
#ifndef ROSCOMMON_MSGS_TRAJECTORY_MSGS_JOINTTRAJECTORY_ACE_H_
#define ROSCOMMON_MSGS_TRAJECTORY_MSGS_JOINTTRAJECTORY_ACE_H_

#include "ROSCommon_msgs/Trajectory_msgs_JointTrajectory.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Trajectory_msgs_JointTrajectory
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Trajectory_msgs_JointTrajectory &data);

// de-serialization operator for DataStructure Trajectory_msgs_JointTrajectory
...
#endif /* ROSCOMMON_MSGS_TRAJECTORY_MSGS_JOINTTRAJECTORY_ACE_H_ */
