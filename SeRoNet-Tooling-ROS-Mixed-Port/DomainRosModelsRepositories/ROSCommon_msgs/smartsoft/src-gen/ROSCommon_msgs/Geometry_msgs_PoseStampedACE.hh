...
//--------------------------------------------------------------------------
#ifndef ROSCOMMON_MSGS_GEOMETRY_MSGS_POSESTAMPED_ACE_H_
#define ROSCOMMON_MSGS_GEOMETRY_MSGS_POSESTAMPED_ACE_H_

#include "ROSCommon_msgs/Geometry_msgs_PoseStamped.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Geometry_msgs_PoseStamped
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Geometry_msgs_PoseStamped &data);

// de-serialization operator for DataStructure Geometry_msgs_PoseStamped
...
#endif /* ROSCOMMON_MSGS_GEOMETRY_MSGS_POSESTAMPED_ACE_H_ */
