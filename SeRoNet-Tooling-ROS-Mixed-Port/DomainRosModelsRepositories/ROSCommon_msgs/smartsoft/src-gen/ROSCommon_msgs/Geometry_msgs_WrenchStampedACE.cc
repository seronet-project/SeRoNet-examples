...
// serialization operator for element Geometry_msgs_WrenchStamped
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Geometry_msgs_WrenchStamped &data)
{
	...
	good_bit = good_bit && cdr << data.wrench;
	
	return good_bit;
}

// de-serialization operator for element Geometry_msgs_WrenchStamped
ACE_CDR::Boolean operator>>(ACE_InputCDR &cdr, ROSCommon_msgsIDL::Geometry_msgs_WrenchStamped &data)
{
	...
	good_bit = good_bit && cdr >> data.header;
	// deserialize type element wrench
	good_bit = good_bit && cdr >> data.wrench;
