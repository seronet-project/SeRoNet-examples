...
//--------------------------------------------------------------------------
#ifndef ROSCOMMON_MSGS_GEOMETRY_MSGS_ACCEL_ACE_H_
#define ROSCOMMON_MSGS_GEOMETRY_MSGS_ACCEL_ACE_H_

#include "ROSCommon_msgs/Geometry_msgs_Accel.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Geometry_msgs_Accel
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Geometry_msgs_Accel &data);

// de-serialization operator for DataStructure Geometry_msgs_Accel
...
#endif /* ROSCOMMON_MSGS_GEOMETRY_MSGS_ACCEL_ACE_H_ */
