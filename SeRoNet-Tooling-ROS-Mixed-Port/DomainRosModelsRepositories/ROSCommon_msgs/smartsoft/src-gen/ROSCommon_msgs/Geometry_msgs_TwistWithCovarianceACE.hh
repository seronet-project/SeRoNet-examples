...
//--------------------------------------------------------------------------
#ifndef ROSCOMMON_MSGS_GEOMETRY_MSGS_TWISTWITHCOVARIANCE_ACE_H_
#define ROSCOMMON_MSGS_GEOMETRY_MSGS_TWISTWITHCOVARIANCE_ACE_H_

#include "ROSCommon_msgs/Geometry_msgs_TwistWithCovariance.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Geometry_msgs_TwistWithCovariance
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Geometry_msgs_TwistWithCovariance &data);

// de-serialization operator for DataStructure Geometry_msgs_TwistWithCovariance
...
#endif /* ROSCOMMON_MSGS_GEOMETRY_MSGS_TWISTWITHCOVARIANCE_ACE_H_ */
