...
// serialization operator for element Sensor_msgs_Illuminance
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Sensor_msgs_Illuminance &data)
{
	...
	// serialize list-element illuminance
	good_bit = good_bit && cdr.write_double(data.illuminance);
...
// de-serialization operator for element Sensor_msgs_Illuminance
ACE_CDR::Boolean operator>>(ACE_InputCDR &cdr, ROSCommon_msgsIDL::Sensor_msgs_Illuminance &data)
{
	ACE_CDR::Boolean good_bit = true;
	// deserialize type element header
	good_bit = good_bit && cdr >> data.header;
	// deserialize type element illuminance
	good_bit = good_bit && cdr.read_double(data.illuminance);
