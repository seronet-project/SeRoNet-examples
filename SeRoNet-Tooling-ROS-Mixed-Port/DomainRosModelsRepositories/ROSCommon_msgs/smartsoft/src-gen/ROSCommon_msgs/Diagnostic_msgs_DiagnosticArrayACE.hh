...
//--------------------------------------------------------------------------
#ifndef ROSCOMMON_MSGS_DIAGNOSTIC_MSGS_DIAGNOSTICARRAY_ACE_H_
#define ROSCOMMON_MSGS_DIAGNOSTIC_MSGS_DIAGNOSTICARRAY_ACE_H_

#include "ROSCommon_msgs/Diagnostic_msgs_DiagnosticArray.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Diagnostic_msgs_DiagnosticArray
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Diagnostic_msgs_DiagnosticArray &data);

// de-serialization operator for DataStructure Diagnostic_msgs_DiagnosticArray
...
#endif /* ROSCOMMON_MSGS_DIAGNOSTIC_MSGS_DIAGNOSTICARRAY_ACE_H_ */
