...
//--------------------------------------------------------------------------
#ifndef ROSCOMMON_MSGS_NAV_MSGS_GETMAPACTIONRESULT_ACE_H_
#define ROSCOMMON_MSGS_NAV_MSGS_GETMAPACTIONRESULT_ACE_H_

#include "ROSCommon_msgs/Nav_msgs_GetMapActionResult.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Nav_msgs_GetMapActionResult
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Nav_msgs_GetMapActionResult &data);

// de-serialization operator for DataStructure Nav_msgs_GetMapActionResult
...
#endif /* ROSCOMMON_MSGS_NAV_MSGS_GETMAPACTIONRESULT_ACE_H_ */
