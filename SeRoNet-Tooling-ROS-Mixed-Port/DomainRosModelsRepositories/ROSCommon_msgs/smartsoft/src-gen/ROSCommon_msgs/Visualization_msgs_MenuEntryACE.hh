...
//--------------------------------------------------------------------------
#ifndef ROSCOMMON_MSGS_VISUALIZATION_MSGS_MENUENTRY_ACE_H_
#define ROSCOMMON_MSGS_VISUALIZATION_MSGS_MENUENTRY_ACE_H_

#include "ROSCommon_msgs/Visualization_msgs_MenuEntry.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Visualization_msgs_MenuEntry
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Visualization_msgs_MenuEntry &data);

// de-serialization operator for DataStructure Visualization_msgs_MenuEntry
...
#endif /* ROSCOMMON_MSGS_VISUALIZATION_MSGS_MENUENTRY_ACE_H_ */
