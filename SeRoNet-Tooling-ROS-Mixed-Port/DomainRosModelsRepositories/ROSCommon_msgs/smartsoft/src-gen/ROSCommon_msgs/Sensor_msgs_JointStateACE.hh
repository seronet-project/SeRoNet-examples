...
//--------------------------------------------------------------------------
#ifndef ROSCOMMON_MSGS_SENSOR_MSGS_JOINTSTATE_ACE_H_
#define ROSCOMMON_MSGS_SENSOR_MSGS_JOINTSTATE_ACE_H_

#include "ROSCommon_msgs/Sensor_msgs_JointState.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Sensor_msgs_JointState
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSCommon_msgsIDL::Sensor_msgs_JointState &data);

// de-serialization operator for DataStructure Sensor_msgs_JointState
...
#endif /* ROSCOMMON_MSGS_SENSOR_MSGS_JOINTSTATE_ACE_H_ */
