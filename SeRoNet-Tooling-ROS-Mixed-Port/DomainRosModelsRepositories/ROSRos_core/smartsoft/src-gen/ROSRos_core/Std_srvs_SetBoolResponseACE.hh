...
//--------------------------------------------------------------------------
#ifndef ROSROS_CORE_STD_SRVS_SETBOOLRESPONSE_ACE_H_
#define ROSROS_CORE_STD_SRVS_SETBOOLRESPONSE_ACE_H_

#include "ROSRos_core/Std_srvs_SetBoolResponse.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Std_srvs_SetBoolResponse
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSRos_coreIDL::Std_srvs_SetBoolResponse &data);

// de-serialization operator for DataStructure Std_srvs_SetBoolResponse
...
#endif /* ROSROS_CORE_STD_SRVS_SETBOOLRESPONSE_ACE_H_ */
