...
#ifndef COMPONENTJOYCOB4_3_EXTENSION_HH_
#define COMPONENTJOYCOB4_3_EXTENSION_HH_
...
public:
	ComponentJoyCob4_3Extension(const std::string &name);
	virtual ~ComponentJoyCob4_3Extension();
...
#endif /* COMPONENTJOYCOB4_3_EXTENSION_HH_ */
