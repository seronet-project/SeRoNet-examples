...
#include "ComponentJoyCob4_3RosPortCallbacksInterface.hh"

class ComponentJoyCob4_3RosPortCallbacks : public ComponentJoyCob4_3RosPortCallbacksInterface {
public:
	ComponentJoyCob4_3RosPortCallbacks();
	virtual ~ComponentJoyCob4_3RosPortCallbacks();
