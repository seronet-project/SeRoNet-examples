...
#include "ComponentJoyCob4_3OpcUaBackendPortFactory.hh"
...
static ComponentJoyCob4_3OpcUaBackendPortFactory OpcUaBackendPortFactory;

ComponentJoyCob4_3OpcUaBackendPortFactory::ComponentJoyCob4_3OpcUaBackendPortFactory()
{  
	componentImpl = 0;
	ComponentJoyCob4_3::instance()->addPortFactory("OpcUa_SeRoNet", this);
}

ComponentJoyCob4_3OpcUaBackendPortFactory::~ComponentJoyCob4_3OpcUaBackendPortFactory()
{  }

void ComponentJoyCob4_3OpcUaBackendPortFactory::initialize(ComponentJoyCob4_3 *component, int argc, char* argv[])
{
	componentImpl = new SeRoNet::Utils::Component(component->connections.component.name);
}

int ComponentJoyCob4_3OpcUaBackendPortFactory::onStartup()
{
	if (!component_thread.joinable()) {
    	component_thread = std::thread(&ComponentJoyCob4_3OpcUaBackendPortFactory::task_execution, this);
    	return 0;
    }
	return -1;
}

Smart::IPushClientPattern<CommBasicObjects::CommJoystick> * ComponentJoyCob4_3OpcUaBackendPortFactory::createJoyIn()
{
...
int ComponentJoyCob4_3OpcUaBackendPortFactory::task_execution()
{
	componentImpl->run();
	return 0;
}

int ComponentJoyCob4_3OpcUaBackendPortFactory::onShutdown(const std::chrono::steady_clock::duration &timeoutTime)
{
...
void ComponentJoyCob4_3OpcUaBackendPortFactory::destroy()
{
