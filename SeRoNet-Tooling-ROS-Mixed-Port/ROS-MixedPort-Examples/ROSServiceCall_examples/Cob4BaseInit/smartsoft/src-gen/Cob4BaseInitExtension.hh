...
#ifndef COB4BASEINIT_EXTENSION_HH_
#define COB4BASEINIT_EXTENSION_HH_
...
public:
	Cob4BaseInitExtension(const std::string &name);
	virtual ~Cob4BaseInitExtension();
...
#endif /* COB4BASEINIT_EXTENSION_HH_ */
