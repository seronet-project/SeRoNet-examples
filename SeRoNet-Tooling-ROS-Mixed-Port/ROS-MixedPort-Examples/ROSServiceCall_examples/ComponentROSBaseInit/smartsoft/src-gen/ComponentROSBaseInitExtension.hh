...
#ifndef COMPONENTROSBASEINIT_EXTENSION_HH_
#define COMPONENTROSBASEINIT_EXTENSION_HH_
...
public:
	ComponentROSBaseInitExtension(const std::string &name);
	virtual ~ComponentROSBaseInitExtension();
...
#endif /* COMPONENTROSBASEINIT_EXTENSION_HH_ */
