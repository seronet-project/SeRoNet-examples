...
#include "ComponentROSBaseInitRosPortCallbacksInterface.hh"

class ComponentROSBaseInitRosPortCallbacks : public ComponentROSBaseInitRosPortCallbacksInterface {
public:
	ComponentROSBaseInitRosPortCallbacks();
	virtual ~ComponentROSBaseInitRosPortCallbacks();
