...
#include "ComponentRosJoystickRosPortCallbacksInterface.hh"

class ComponentRosJoystickRosPortCallbacks : public ComponentRosJoystickRosPortCallbacksInterface {
public:
	ComponentRosJoystickRosPortCallbacks();
	virtual ~ComponentRosJoystickRosPortCallbacks();
	
	virtual void _joy_cb (const sensor_msgs::Joy::ConstPtr &msg) override;
