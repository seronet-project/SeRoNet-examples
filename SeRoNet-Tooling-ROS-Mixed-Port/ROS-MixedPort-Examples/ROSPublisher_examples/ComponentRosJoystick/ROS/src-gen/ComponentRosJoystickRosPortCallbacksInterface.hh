...
class ComponentRosJoystickRosPortCallbacksInterface {
public:
	ComponentRosJoystickRosPortCallbacksInterface() { };
	virtual ~ComponentRosJoystickRosPortCallbacksInterface() { }
	
	virtual void _joy_cb (const sensor_msgs::Joy::ConstPtr &msg) = 0;
