...
#ifndef COMPONENTROSUR_DRIVER_EXTENSION_HH_
#define COMPONENTROSUR_DRIVER_EXTENSION_HH_
...
public:
	ComponentRosur_driverExtension(const std::string &name);
	virtual ~ComponentRosur_driverExtension();
...
#endif /* COMPONENTROSUR_DRIVER_EXTENSION_HH_ */
