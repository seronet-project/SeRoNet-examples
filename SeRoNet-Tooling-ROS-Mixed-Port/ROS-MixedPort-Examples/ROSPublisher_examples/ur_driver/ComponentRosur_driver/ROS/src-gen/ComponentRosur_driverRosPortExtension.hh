...
class ComponentRosur_driverRosPortExtension : public ComponentRosur_driverExtension, public ComponentRosur_driverRosPortBaseClass
{
private:
	ros::NodeHandle *nh;
	
	ComponentRosur_driverRosPortCallbacks *callbacksPtr;
	
	virtual int extensionExecution() override;
public:
	ComponentRosur_driverRosPortExtension();
	virtual ~ComponentRosur_driverRosPortExtension();
	...
	inline ros::Subscriber* getJoint_states_subPtr() {
		return &joint_states_sub;
	}
