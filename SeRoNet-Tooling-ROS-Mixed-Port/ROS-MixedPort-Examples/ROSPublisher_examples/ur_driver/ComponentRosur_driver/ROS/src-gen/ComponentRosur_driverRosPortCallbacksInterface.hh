...
class ComponentRosur_driverRosPortCallbacksInterface {
public:
	ComponentRosur_driverRosPortCallbacksInterface() { };
	virtual ~ComponentRosur_driverRosPortCallbacksInterface() { }
	
	virtual void joint_states_sub_cb (const sensor_msgs::JointState::ConstPtr &msg) = 0;
