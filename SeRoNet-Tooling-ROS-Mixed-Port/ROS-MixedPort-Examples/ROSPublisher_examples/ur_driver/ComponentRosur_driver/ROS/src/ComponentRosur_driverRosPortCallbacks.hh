...
#include "ComponentRosur_driverRosPortCallbacksInterface.hh"

class ComponentRosur_driverRosPortCallbacks : public ComponentRosur_driverRosPortCallbacksInterface {
public:
	ComponentRosur_driverRosPortCallbacks();
	virtual ~ComponentRosur_driverRosPortCallbacks();
	
	virtual void joint_states_sub_cb (const sensor_msgs::JointState::ConstPtr &msg) override;
