...
//--------------------------------------------------------------------------
#ifndef ROSUR_MSGS_UR_MSGS_IOSTATES_ACE_H_
#define ROSUR_MSGS_UR_MSGS_IOSTATES_ACE_H_

#include "ROSUr_msgs/Ur_msgs_IOStates.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Ur_msgs_IOStates
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSUr_msgsIDL::Ur_msgs_IOStates &data);

// de-serialization operator for DataStructure Ur_msgs_IOStates
...
#endif /* ROSUR_MSGS_UR_MSGS_IOSTATES_ACE_H_ */
