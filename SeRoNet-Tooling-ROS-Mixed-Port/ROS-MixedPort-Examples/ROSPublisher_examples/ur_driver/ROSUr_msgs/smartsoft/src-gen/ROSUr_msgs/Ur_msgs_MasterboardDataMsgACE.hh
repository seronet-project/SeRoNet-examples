...
//--------------------------------------------------------------------------
#ifndef ROSUR_MSGS_UR_MSGS_MASTERBOARDDATAMSG_ACE_H_
#define ROSUR_MSGS_UR_MSGS_MASTERBOARDDATAMSG_ACE_H_

#include "ROSUr_msgs/Ur_msgs_MasterboardDataMsg.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Ur_msgs_MasterboardDataMsg
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSUr_msgsIDL::Ur_msgs_MasterboardDataMsg &data);

// de-serialization operator for DataStructure Ur_msgs_MasterboardDataMsg
...
#endif /* ROSUR_MSGS_UR_MSGS_MASTERBOARDDATAMSG_ACE_H_ */
