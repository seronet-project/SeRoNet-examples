...
//--------------------------------------------------------------------------
#ifndef ROSUR_MSGS_UR_MSGS_ROBOTMODEDATAMSG_ACE_H_
#define ROSUR_MSGS_UR_MSGS_ROBOTMODEDATAMSG_ACE_H_

#include "ROSUr_msgs/Ur_msgs_RobotModeDataMsg.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure Ur_msgs_RobotModeDataMsg
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const ROSUr_msgsIDL::Ur_msgs_RobotModeDataMsg &data);

// de-serialization operator for DataStructure Ur_msgs_RobotModeDataMsg
...
#endif /* ROSUR_MSGS_UR_MSGS_ROBOTMODEDATAMSG_ACE_H_ */
