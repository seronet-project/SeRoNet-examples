...
#include "ComponentRosjoy_nodeRosPortCallbacksInterface.hh"

class ComponentRosjoy_nodeRosPortCallbacks : public ComponentRosjoy_nodeRosPortCallbacksInterface {
public:
	ComponentRosjoy_nodeRosPortCallbacks();
	virtual ~ComponentRosjoy_nodeRosPortCallbacks();
	
	virtual void joy_sub_cb (const sensor_msgs::Joy::ConstPtr &msg) override;
