...
class ComponentRosjoy_nodeRosPortCallbacksInterface {
public:
	ComponentRosjoy_nodeRosPortCallbacksInterface() { };
	virtual ~ComponentRosjoy_nodeRosPortCallbacksInterface() { }
	
	virtual void joy_sub_cb (const sensor_msgs::Joy::ConstPtr &msg) = 0;
