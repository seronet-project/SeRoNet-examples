...
#ifndef COMPONENTROSJOY_NODE_EXTENSION_HH_
#define COMPONENTROSJOY_NODE_EXTENSION_HH_
...
public:
	ComponentRosjoy_nodeExtension(const std::string &name);
	virtual ~ComponentRosjoy_nodeExtension();
...
#endif /* COMPONENTROSJOY_NODE_EXTENSION_HH_ */
