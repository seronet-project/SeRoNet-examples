...
//--------------------------------------------------------------------------
#ifndef _JOY_NODEACTIVITY_CORE_HH
#define _JOY_NODEACTIVITY_CORE_HH
...
protected:
	...
	Smart::StatusCode joyOutPut(ROSCommon_msgs::Sensor_msgs_Joy &joyOutDataObject);
...
private:
	...
	std::list<Joy_nodeActivityObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(Joy_nodeActivityObserverInterface *observer);
	void detach_interaction_observer(Joy_nodeActivityObserverInterface *observer);

public:
	Joy_nodeActivityCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~Joy_nodeActivityCore();
