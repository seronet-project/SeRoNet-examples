...
#ifndef STRINGSERVICEQUERY_EXTENSION_HH_
#define STRINGSERVICEQUERY_EXTENSION_HH_
...
public:
	StringServiceQueryExtension(const std::string &name);
	virtual ~StringServiceQueryExtension();
...
#endif /* STRINGSERVICEQUERY_EXTENSION_HH_ */
