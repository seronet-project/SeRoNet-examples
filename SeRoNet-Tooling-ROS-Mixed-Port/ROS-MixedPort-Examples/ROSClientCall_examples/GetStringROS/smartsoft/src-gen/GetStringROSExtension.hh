...
#ifndef GETSTRINGROS_EXTENSION_HH_
#define GETSTRINGROS_EXTENSION_HH_
...
public:
	GetStringROSExtension(const std::string &name);
	virtual ~GetStringROSExtension();
...
#endif /* GETSTRINGROS_EXTENSION_HH_ */
