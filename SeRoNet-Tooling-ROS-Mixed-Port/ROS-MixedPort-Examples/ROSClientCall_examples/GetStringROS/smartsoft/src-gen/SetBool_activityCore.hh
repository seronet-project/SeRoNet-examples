...
//--------------------------------------------------------------------------
#ifndef _SETBOOL_ACTIVITY_CORE_HH
#define _SETBOOL_ACTIVITY_CORE_HH
...
private:
	...
	std::list<SetBool_activityObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(SetBool_activityObserverInterface *observer);
	void detach_interaction_observer(SetBool_activityObserverInterface *observer);

public:
	SetBool_activityCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~SetBool_activityCore();
