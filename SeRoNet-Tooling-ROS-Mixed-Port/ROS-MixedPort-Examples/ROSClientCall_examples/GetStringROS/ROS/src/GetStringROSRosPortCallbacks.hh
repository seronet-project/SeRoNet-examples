...
#include "GetStringROSRosPortCallbacksInterface.hh"

class GetStringROSRosPortCallbacks : public GetStringROSRosPortCallbacksInterface {
public:
	GetStringROSRosPortCallbacks();
	virtual ~GetStringROSRosPortCallbacks();
	
	virtual bool _set_bool_cb (std_srvs::SetBool::Request &req, std_srvs::SetBool::Response &res) override;
