...
class GetStringROSRosPortCallbacksInterface {
public:
	GetStringROSRosPortCallbacksInterface() { };
	virtual ~GetStringROSRosPortCallbacksInterface() { }
	
	virtual bool _set_bool_cb (std_srvs::SetBool::Request &req, std_srvs::SetBool::Response &res) = 0;
