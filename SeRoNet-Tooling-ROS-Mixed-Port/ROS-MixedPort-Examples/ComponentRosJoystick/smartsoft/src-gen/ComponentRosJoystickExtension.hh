...
#ifndef COMPONENTROSJOYSTICK_EXTENSION_HH_
#define COMPONENTROSJOYSTICK_EXTENSION_HH_
...
public:
	ComponentRosJoystickExtension(const std::string &name);
	virtual ~ComponentRosJoystickExtension();
...
#endif /* COMPONENTROSJOYSTICK_EXTENSION_HH_ */
